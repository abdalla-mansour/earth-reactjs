  ...
  return (
    <div className="w-full bg-black text-white text-center">
      <div className="max-w-[1240px] mx-auto px-4 py-16 ">
        <div>
          <h1 className="py-4 text-[25px]">A Growing Protocol Ecosystem</h1>
          <p className="py-10 text-xl text-[16px]">
